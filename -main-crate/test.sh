...
# test.sh - Run tests for each feature in the easy-macros crate

set -e

echo "========================================="
echo "Running tests for easy-macros crate features"
echo "========================================="
echo
...
run_test "all-syntax-cases"
run_test "always-context"
run_test "attributes"
run_test "anyhow-result"
run_test "context"
